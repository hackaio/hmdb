...
@section('content')
	<div class="home home--static">
		...
		@php $responses = file_get_contents($_SERVER['TMDB_URI']."/trending/all/day?api_key=".$_ENV['TMDB_API']."&language=en-US");
			 $responses = json_decode($responses, true);
			 $responses = $responses['results'];
		@endphp
			@foreach ($responses as $movie)
			<div class="home__card" style="width:200px">
				<a href="details.html">
					<img src="{{$_ENV['TMDB_URL'].$movie['backdrop_path']}}" alt="">
				</a>
				<div>
					<h2></h2>
					<ul>
				...
				<div class="col-12">
					<div class="catalog__nav">
						<div class="catalog__select-wrap">
							<h1 style="color: aliceblue">Popular Movies</h1>
						</div>
						...
						@foreach ($responses as $movie)
							<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
								<div class="card">
									...
									<h3 class="card__title"><a href="details.html" title="{{$movie['original_title']}}">{{$movie['original_title']}}</a></h3>
									<ul class="card__list">
										<li>Free</li>
										<li>Action</li>
										<li>{{substr($movie['release_date'], 0,4)}}</li>
									</ul>
								</div>
							</div>
						@endforeach
